...
def parse_args():
    ...
    parser.add_argument('--pcol', type=str, default="P", help='p-value', required=True)
    parser.add_argument('--chr', type=str, default="#CHROM", help='CHR', required=True)
    parser.add_argument('--pos', type=str, default="POS", help='POS', required=True)
